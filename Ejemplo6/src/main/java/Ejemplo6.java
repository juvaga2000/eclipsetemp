...
public class Ejemplo6 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.getWriter().append("Parametro inicial de contexto: ").append(paramContext + "\n");
		response.getWriter().append("Parametro inicial de contexto desde request: ").append(getServletConfig()
